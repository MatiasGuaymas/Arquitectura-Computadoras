...
OCHO:           .byte 0xFE
NUEVE:          .byte 0xDE
MSJ:            .asciiz "Ingrese un numero natural 0 a 9: "
...
SEGMENTO1:      andi $t0,$s2,0x2    #T0=SEGMENTO1
...
SEGMENTO2:      andi $t0,$s2,0x4    #T0=SEGMENTO2
...
SEGMENTO3:      andi $t0,$s2,0x8    #T0=SEGMENTO3
...
SEGMENTO4:      andi $t0,$s2,0x10    #T0=SEGMENTO4
...
SEGMENTO5:      andi $t0,$s2,0x20    #T0=SEGMENTO5
...
SEGMENTO6:      andi $t0,$s2,0x40    #T0=SEGMENTO6
...
SEGMENTO7:      andi $t0,$s2,0x80   #T0=SEGMENTO7
...
FIN:            halt
                ...
                #Renderiza una linea horizontal o vertical, S0=CONTROL S1=DATA A0=Yinicial A1=Xinicial A2=LONGITUD A3=DIRECCION:horizontal(0)/vertical(1) 
LINEA:          daddi $sp,$sp,-8    #push ra
                sd $ra,0($sp)       #push ra
...
IMPRIMIR_V:     beqz $s4,TERMINAR   #TERMINAR SI LONGITUD = 0
                dadd $a0,$0,$s2     #A0=Y
...
HORIZONTAL:     dadd $s2,$0,$a1     #S2=Xinicial
                dadd $s3,$0,$a0     #S3=Yinicial
IMPRIMIR_H:     beqz $s4,TERMINAR   #TERMINAR SI LONGITUD = 0
...
TERMINAR:       ld $s4,0($sp)       #pop s4
                ...
                #Renderiza un pixel negro en las cordenadas recibidas, A0=Y A1=X S0=CONTROL S1=DATA
PUNTO:          dadd $t0,$0,$0      #t0=0
